				...
				<div class="nav-collapse">
					<ul class="nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">								
								<li><a href="form_negocio.php" target="centro" onclick="getElementById('centro').height='750px'"><i class="icon-file"></i> Nuevo</a></li>
								...
								<li><a href="form_traspaso.php" target="centro" onclick="getElementById('centro').height='750'"><img src="./../img/icon-transfer.png" width="14px" height="14px"> Traspaso</a></li>
								<li><a href="form_cierre.php" target="centro" onclick="getElementById('centro').height='750'"><i class="icon-ban-circle"></i> Cierre</a></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="form_inmueble.php" target="centro" onclick="getElementById('centro').height='800px'"><i class="icon-file"></i> Nuevo</a></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="form_alumbrado.php" target="centro" onclick="getElementById('centro').height='680px'"><i class="icon-file"></i> Nuevo</a></li>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
									<li><a target="centro" href="cons_catastro.php" onclick="getElementById('centro').height='1000px'"><i class="icon-search"></i> Graficas</a></li>
