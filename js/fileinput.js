...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'btn btn-ppal',
        removeLabel: 'Remover',
        removeTitle: 'Remover archivos seleccionados',
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) excede el tamaño máximo permitido de <b>{maxSize} KB</b>. Por favor reintenta subirlo!',
        msgFilesTooMany: 'Número de filas seleccionadas para subir <b>({n})</b> excede el tamaño máximo permitido de <b>{m}</b>. Por favor reintenta subirlo!',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileNotReadable: 'Archivo "{name}" no es legible.',
        msgFilePreviewAborted: 'Vista previa abortada para "{name}".',
        msgFilePreviewError: 'Un error ha ocurrido mientras se leía "{name}".',
        msgInvalidFileType: 'Tipo inválido para archivo "{name}". Solamente "{types}" archivos son permitidos.',
        msgInvalidFileExtension: 'Extensión inválida para archivo "{name}". Solamente "{extensions}" archivos son soportados.',
